					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form action="/user_management_system/controller/user/add_user.php" method="post">
									...
									<input type="text" placeholder="Surame" name="surname" class="form-control mb" required>

									<label for="" class="text-uppercase text-sm">Group Id</label>
									<input type="text" placeholder="Group Id" name="group_id" class="form-control mb" required>
